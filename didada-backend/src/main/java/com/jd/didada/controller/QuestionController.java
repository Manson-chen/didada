...
import com.jd.didada.common.DeleteRequest;
...
import com.jd.didada.model.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<Long> addQuestion(@RequestBody QuestionAddRequest questionAddRequest, HttpServletRequest request) {
        ...
        List<QuestionContentDTO> questionContentDTOList = questionAddRequest.getQuestionContent();
        question.setQuestionContent(JSONUtil.toJsonStr(questionContentDTOList));
    ...
    public BaseResponse<Boolean> updateQuestion(@RequestBody QuestionUpdateRequest questionUpdateRequest) {
        ...
        List<QuestionContentDTO> questionContentDTOList = questionUpdateRequest.getQuestionContent();
        question.setQuestionContent(JSONUtil.toJsonStr(questionContentDTOList));
        // 数据校验
    ...
    public BaseResponse<Boolean> editQuestion(@RequestBody QuestionEditRequest questionEditRequest, HttpServletRequest request) {
        ...
        List<QuestionContentDTO> questionContentDTOList = questionEditRequest.getQuestionContent();
        question.setQuestionContent(JSONUtil.toJsonStr(questionContentDTOList));
        // 数据校验
        questionService.validQuestion(question, false);
        User loginUser = userService.getLoginUser(request);
    ...
    private String getGenerateQuestionUserMessage(App app, int questionNumber, int optionNumber) {
        ...
        userMessage.append(AppTypeEnum.getEnumByValue(app.getAppType())).append("\n");
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(
        ...
        List<QuestionContentDTO> questionContentDTOList = JSONUtil.toList(resultJson, QuestionContentDTO.class);
